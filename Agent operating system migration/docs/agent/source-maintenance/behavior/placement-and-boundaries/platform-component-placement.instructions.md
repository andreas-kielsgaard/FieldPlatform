# Source Maintenance Behavior: Platform Component Placement
...
5. Decide create, reuse existing owner, defer, or log a temporary boundary.
...
Update `technology-architecture-map.md` for canonical directory, ownership, source/generated boundaries, and interface expectations.

Update `decision-log.md` for accepted or rejected platform boundaries.
