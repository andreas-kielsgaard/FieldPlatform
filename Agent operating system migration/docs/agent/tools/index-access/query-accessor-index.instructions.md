# Tool: Query Accessor Index

Tool ID: `query-accessor-index`

Script: `tools/agent/index-access/query-accessor-index.ts`

## Purpose

Return a bounded slice of `docs/agent/generated-indexes/accessor-map.md` for requested accessors, API routes, return shapes, cache behaviors, and consumers.

## Expected Invocation

```powershell
npx tsx tools/agent/index-access/query-accessor-index.ts "<query-or-target>"
```
