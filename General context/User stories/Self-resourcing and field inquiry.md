---
title: Self-resourcing And Field Inquiry
layer: user stories
...
- Do not require a complete resource graph.
- Let most daily signals expire unless intentionally carried forward.
- Keep visibility scoped.
- Make direct human movement available when better than the app.
- Do not turn needs-first support into therapy, a feed, a resource database, or project management.
