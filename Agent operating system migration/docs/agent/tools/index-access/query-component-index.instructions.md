# Tool: Query Component Index

Tool ID: `query-component-index`

Script: `tools/agent/index-access/query-component-index.ts`

## Purpose

Return a bounded slice of `docs/agent/generated-indexes/component-registry.md` for requested components, shared UI surfaces, consumers, examples, stories, and tests.

## Expected Invocation

```powershell
npx tsx tools/agent/index-access/query-component-index.ts "<query-or-target>"
```
