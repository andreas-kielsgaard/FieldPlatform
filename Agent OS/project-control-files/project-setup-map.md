...
| Reusable Agent OS extraction or installation-planning handoff from the Field Platform reference installation | `project-control-files/agent-os-reusable-extraction-handoff.md` |
