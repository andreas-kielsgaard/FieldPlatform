# Tool: Query Naming Index

Tool ID: `query-naming-index`

Script: `tools/agent/index-access/query-naming-index.ts`

## Purpose

Return a bounded slice of `docs/agent/generated-indexes/naming-index.md` for requested canonical terms, aliases, avoided names, literals, route labels, and identifiers.

## Expected Invocation

```powershell
npx tsx tools/agent/index-access/query-naming-index.ts "<query-or-target>"
```
