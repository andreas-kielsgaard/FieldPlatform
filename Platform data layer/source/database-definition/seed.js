function createInitialPlatformSnapshot() {
  const people = [
    {
      id: "p_maya",
      name: "Maya Holm",
  ...
  const festivals = [
    {
      id: "f_movement_bridge",
      title: "Aarhus Movement Bridge Weekend",
      summary: "A three-day gathering for movement, consent, relational practice, and low-pressure social landing.",
      hostGroupIds: ["ci", "somatic", "ecstatic", "tea"],
      venueIds: ["v_dome", "v_godsbanen", "v_teahouse"],
      time: "May 22-24",
      tags: ["movement", "somatics", "consent", "social", "festival"],
      attendance: {
        interested: ["p_maya", "p_liv", "p_emil", "p_jonas", "p_casey"],
        attending: ["p_casey", "p_ella", "p_kai", "p_noa", "p_freja", "p_tobias"]
      },
      subEvents: [
        {
          id: "fs_bridge_opening",
          title: "Opening: Consent Across Movement Rooms",
          time: "Fri 18:00",
          venueId: "v_dome",
          hostGroupIds: ["ci", "somatic"],
          tags: ["consent", "movement", "beginner-friendly"],
          participationMode: "bridge",
          note: "A shallow entry into shared agreements before the weekend branches out."
        },
        {
          id: "fs_somatic_lab",
          title: "Somatic Lab for Practitioners",
          time: "Sat 11:00",
          venueId: "v_attune",
          hostGroupIds: ["somatic"],
          tags: ["somatics", "peer learning", "depth"],
          participationMode: "depth",
          note: "A deeper session for people with some practice background."
        },
        {
          id: "fs_ecstatic_social",
          title: "Dance Floor to Tea Table",
          time: "Sat 20:30",
          venueId: "v_godsbanen",
          hostGroupIds: ["ecstatic", "tea"],
          tags: ["dance", "integration", "social"],
          participationMode: "bridge",
          note: "A clear bridge from expressive movement into social landing."
        },
        {
          id: "fs_closing_circle",
          title: "Closing Circle and Next Doors",
          time: "Sun 14:00",
          venueId: "v_teahouse",
          hostGroupIds: ["tea", "circling"],
          tags: ["connection", "reflection", "continuity"],
          participationMode: "continuity",
          note: "Helps participants orient toward what to continue after the festival."
        }
      ]
    }
  ];
  ...
  const forumThreads = [
    {
      ...
      scopeType: "community",
      scopeId: "ci",
      title: "What helps first-time movers feel safe at jam?",
      authorId: "p_ella",
      lastActivity: "2h ago",
      replies: 8,
      tags: ["entry", "consent", "newcomers"]
    },
    {
      id: "th_circling_intro",
      scopeType: "community",
      scopeId: "circling",
      title: "Monthly intro: what should be named before depth?",
      authorId: "p_rune",
      lastActivity: "yesterday",
      replies: 5,
      tags: ["entry", "agreements"]
    },
    {
      id: "th_tea_aftercare",
      scopeType: "community",
      scopeId: "tea",
      title: "Soft landing after bigger rooms",
      authorId: "p_freja",
      lastActivity: "3d ago",
      replies: 11,
      tags: ["integration", "hosting"]
    },
    {
      id: "th_festival_arrivals",
      scopeType: "festival",
      scopeId: "f_movement_bridge",
      title: "Where are people arriving from?",
      authorId: "p_casey",
      lastActivity: "28m ago",
      replies: 14,
      tags: ["orientation", "arrivals", "meetups"]
    },
    {
      id: "th_festival_schedule",
      scopeType: "festival",
      scopeId: "f_movement_bridge",
      title: "Choosing between bridge sessions and deeper labs",
      authorId: "p_kai",
      lastActivity: "1h ago",
      replies: 9,
      tags: ["schedule", "depth", "bridge"]
    },
    {
      id: "th_festival_after",
      scopeType: "festival",
      scopeId: "f_movement_bridge",
      title: "What continues after Sunday?",
      authorId: "p_noa",
      lastActivity: "today",
      replies: 6,
      tags: ["continuity", "communities"]
    }
  ];
...
if (typeof window !== "undefined") {
  window.FieldPlatformSeed = { createInitialPlatformSnapshot };
}

if (typeof module !== "undefined" && module.exports) {
  module.exports = { createInitialPlatformSnapshot };
}
