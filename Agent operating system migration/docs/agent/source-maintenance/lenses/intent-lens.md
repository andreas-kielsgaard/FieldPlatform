...
- The task may or may not need source maintenance.
...
- Does this task require source maintenance at all?

## Evidence To Consider

- User request and recent clarifications.
- Current task-mode selection.
- Existing code, examples, maps, or tests directly named by the request.
...
- The structural implication is definite and no source-maintenance decision has been selected.

## Cheap Pass

The change is a small local edit that does not alter exports, shared names, data shape, route behavior, public interfaces, or durable source structure.
