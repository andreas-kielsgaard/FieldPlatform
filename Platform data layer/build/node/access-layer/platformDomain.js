...
const dataShareRequestRepository_1 = require("./repositories/dataShareRequestRepository");
...
const visibilityGrantRepository_1 = require("./repositories/visibilityGrantRepository");
...
const dataShareService_1 = require("./services/dataShareService");
...
class PlatformDomain {
    constructor(options = {}) {
        ...
        this.dataShares = new dataShareService_1.DataShareService(this);
        ...
        this.dataShareRequests = new dataShareRequestRepository_1.DataShareRequestRepository(this);
        this.visibilityGrants = new visibilityGrantRepository_1.VisibilityGrantRepository(this);
