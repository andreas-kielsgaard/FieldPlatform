...
1. [What FieldPlatform is](Principles/What%20FieldPlatform%20is.md): what the platform feels like to use and what it makes visible.
...
The first page branches into role pages for [participants](Principles/FieldPlatform%20for%20participants.md), [creators](Principles/FieldPlatform%20for%20creators.md), and [communities](Principles/FieldPlatform%20for%20communities.md).

Use [Project words in plain English](Glossary/Project%20words%20in%20plain%20English.md) whenever a term feels too internal.

## Navigation Sections

- [Principles](Principles/What%20FieldPlatform%20is.md): what the platform is, the design philosophy behind it, and the product failure modes to avoid.
