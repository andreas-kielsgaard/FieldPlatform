...
Update `technology-architecture-map.md` when a technology area, runtime, toolchain, or source/generated boundary becomes durable.

Update `decision-log.md` when a choice affects future work or rejects a plausible alternative.
