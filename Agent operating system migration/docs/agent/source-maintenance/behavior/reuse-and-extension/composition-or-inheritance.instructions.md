# Source Maintenance Behavior: Composition, Inheritance, Or Adaptation Strategy

## Purpose

Decide how a new or changed source element should relate to existing behavior: compose, wrap, parameterize, extend, inherit, adapt, or define from scratch.
...
4. Choose composition, wrapping/adaptation, extension, inheritance, local definition, or defer.
5. Add secondary boundary, extension, or near-match behavior when strategy choice reveals a separate structural decision.
...
- The local source element owns orchestration.
...
Update `decision-log.md` when an adaptation strategy becomes a reusable convention.
