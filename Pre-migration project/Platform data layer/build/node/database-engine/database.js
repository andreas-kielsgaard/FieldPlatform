...
const FieldPlatformDatabase = (() => {
    ...
    function createDataLayer(options = {}) {
        ...
        function list(collectionName, options = {}) {
            ...
            if (options.sortBy)
                records = sortRecords(records, options.sortBy, options.direction);
        ...
        function update(collectionName, id, patchOrUpdater) {
            ...
            mutate(draft => {
                ...
                if (index < 0)
                    throw new Error(`Cannot update missing ${collectionName} record: ${id}`);
