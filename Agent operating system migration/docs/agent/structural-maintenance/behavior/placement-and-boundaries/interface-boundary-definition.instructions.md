...
5. Use `contract-impact` and `contract-test-coverage` when the boundary carries consumer-visible promises or compatibility risk.
...
Update `project-setup/technology-architecture-map.md` when interface expectations between components change.

Update `generated-indexes/accessor-map.md`, `generated-indexes/schema-map.md`, `generated-indexes/state-management-map.md`, or policy maps when their boundary is involved.
