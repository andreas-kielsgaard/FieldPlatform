...
Update `generated-indexes/naming-index.md` and `domain-glossary.md` when canonical names, aliases, deprecated names, unresolved language, or meaning changes are involved.
