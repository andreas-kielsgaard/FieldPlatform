# Tool: Update Schema Index

Tool ID: `update-schema-index`

Script: `tools/agent/index-access/update-schema-index.ts`

## Purpose

Refresh generated `docs/agent/generated-indexes/schema-map.md` data for schemas, validators, generated types, persistence shapes, fixture shapes, and drift evidence, or report that refresh is unavailable.

## Expected Invocation

```powershell
npx tsx tools/agent/index-access/update-schema-index.ts
```
