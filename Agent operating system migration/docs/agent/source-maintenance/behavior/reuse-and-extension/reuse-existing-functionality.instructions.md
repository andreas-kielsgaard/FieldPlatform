...
4. Choose reuse unchanged, compose/wrap, extend, branch, create local one-off, or avoid.
5. Add secondary behavior when mismatch points to extension, near-match branching, extraction, movement, or deprecation.
...
- Reuse modifies a shared/stable source element.
