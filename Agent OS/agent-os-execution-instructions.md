...
- Use human-maintained maps, selected source reads, `rg`, active replacement tools (`change-surface`, `test-selection`, `change-verification`, `repo-health`, `depcruise:active-source`), and standard project checks to orient in the workspace.
