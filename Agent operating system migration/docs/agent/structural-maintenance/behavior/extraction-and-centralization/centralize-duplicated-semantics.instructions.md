...
Update `domain-glossary.md` and `generated-indexes/naming-index.md` when terms or semantics become canonical, provisional, deprecated, or intentionally unresolved.
