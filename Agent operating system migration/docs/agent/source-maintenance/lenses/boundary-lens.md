...
- A source element imports or consumes behavior from another area.
...
- UI or surface code needs raw policy, schema, persistence, or tool internals.
- A project tool becomes a runtime dependency for product code.
