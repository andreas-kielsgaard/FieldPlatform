...
Evidence notes (legacy generated indexes inactive): source/config/tooling and relevant project decisions if present.
Proposed semantic context: source/config/tooling, area-specific maps, and `project-decisions/project-decision-map.md` when mature project decisions are relevant.
...
Evidence notes (legacy generated indexes inactive): source/config/tooling and relevant project decisions if present.
Proposed semantic context: source/config/tooling and `project-decisions/project-decision-map.md` when mature technology or architecture decisions are relevant.
...
Evidence notes (legacy generated indexes inactive): `tool-maintained-files/indexes/symbol-index.json`, `tool-maintained-files/indexes/dependency-index.json`
...
Evidence notes (legacy generated indexes inactive): `tool-maintained-files/indexes/accessor-index.json`, `tool-maintained-files/indexes/schema-shape-index.json`, `tool-maintained-files/indexes/dependency-index.json`
Proposed semantic context: source/config/tooling, area-specific maps, and relevant project decisions if present.
...
Evidence notes (legacy generated indexes inactive): `tool-maintained-files/indexes/component-index.json`
Proposed semantic context: source/config/tooling, area-specific maps, and relevant project decisions if present.
...
Proposed semantic context: area-specific maps, source-owned names, and relevant project decisions if present.
...
Evidence notes (legacy generated indexes inactive): `tool-maintained-files/indexes/dependency-index.json`
Proposed semantic context: source/config/tooling, area-specific maps, and relevant project decisions if present.
...
Proposed semantic context: area-specific maps, source/config/tooling, and relevant project decisions if present.

Behavior: Trim unused element
Behavior details: `behavior/lifecycle-and-pruning/trim-unused-element.instructions.md`
Proposed for: Tool output or inspection indicates an obsolete, abandoned, unreachable, or unused maintained element; scoped cleanup identifies obsolete content; a deprecated element reached its removal trigger.
...
Evidence notes (legacy generated indexes inactive):
Proposed semantic context: relevant durable memory, project decisions if present, relevant maps and instruction files.
