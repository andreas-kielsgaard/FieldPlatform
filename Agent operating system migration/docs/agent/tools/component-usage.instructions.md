...
Script: `tools/agent/component-usage.ts`
...
```powershell
npx tsx tools/agent/component-usage.ts "<component-name-or-pattern>"
```
...
This tool does not decide whether a component should be shared. Use component-registry and mode instructions for that judgment.
