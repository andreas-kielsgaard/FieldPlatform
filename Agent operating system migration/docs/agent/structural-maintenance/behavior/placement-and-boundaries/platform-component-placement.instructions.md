...
Update `project-setup/technology-architecture-map.md` for canonical directory, ownership, source/generated boundaries, and interface expectations.

Update the deferred logging strategy for accepted or rejected platform boundaries.
