...
4. Use `contract-impact` and `contract-test-coverage` when extension may alter promised behavior for existing consumers.
...
Update the deferred logging strategy when extension establishes a convention.
