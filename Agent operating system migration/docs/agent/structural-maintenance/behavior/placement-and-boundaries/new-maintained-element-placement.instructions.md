...
Update `project-setup/technology-architecture-map.md` when placement creates or changes an architectural boundary.

Update the deferred logging strategy when placement establishes a convention future agents should follow.
